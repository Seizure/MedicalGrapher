 ...
 */
public class ReferralUIOLD extends Stage {
    ...
    //Dept. Pane components
    Button addDeptBtn = new Button("Add Department");
    TextField deptField = new TextField();
    TableView deptTable = new TableView();
    HBox deptHBox = new HBox();
    VBox deptVBox = new VBox();



    public ReferralUIOLD(){
        init();
    }
